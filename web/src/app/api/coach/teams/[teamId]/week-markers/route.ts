...
import { createTeamScheduleWeekMarker } from '@/services/team-training'
...
export async function POST(request: Request, { params }: { params: Promise<{ teamId: string }> }) {
  ...
  const result = await createTeamScheduleWeekMarker(context.coachProfile, Number(teamId), body ?? {})
